"""
Underwater Species Detection — Two-Pass Tiled YOLO + Smart NMS
==============================================================

Architecture-agnostic detection module. Works with any upstream
enhancement pipeline (NAFNet, U-Net, raw images, etc.).
...
def draw(img, dets):
    """Draw detection boxes and species labels on image."""
    out = img.copy()
